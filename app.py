...
# 统一封装并安全注入 CSS 样式
# 【终极完美修复】去除了任何会误杀原生 header 和 button 的代码
# 只精准打击右上角部署菜单 (stToolbar) 和右下角 Manage App (iframe)
unified_css = f"""
<style>
#MainMenu {{visibility: hidden;}} 
footer {{visibility: hidden;}}

/* 仅精准隐藏右上角多余工具栏、装饰线，以及右下角的 Manage App iframe，绝不触碰任何原生的 button 元素 */
